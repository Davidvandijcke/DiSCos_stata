...
quietly: disco y id time, idtarget(1) t0(10) agg("quantileDiff") graph
mata {
...
quietly: disco y id time, idtarget(1) t0(10) agg("cdf") graph // TODO: fix     - local gmin = `min' = local gmin = 
